...
//Factories
     ...
     * @return a new pair with newLeft as the left element, and the same right
     * element as old
     */
     ...
     * @return a new pair with newRight as the right element, and the same left
     * element as old
     */
...
//Queries
    ...
    @Override
    public Object clone() {
        return make(this.left, this.right);
    }
